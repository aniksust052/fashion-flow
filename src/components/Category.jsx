                ...
                <ul className="menu-list flx-wrp ">
                    {
                        data.menuList.map( (el, i) => {
                            return(
                                <li>
                                    <a className={(el === 'All'? "txt-upper pink-col f-wt" : "u-list-item txt-upper")} href="#">{el}</a>
                                </li>
                            );
                        } )
                    }
                            ...
                            return(
                                <div className="cat-list" key={i}>
                                    ...
                                    <div className="list-con">
                                        <a className="btn btnb" href="#">{el.btnTxt}</a>
                                        <div className="txt-ft-16 ptop20">{el.title}</div>
                                        <div className="created-by created-by-b">{data.createdBy} <span className="edge edgeb"></span> {data.time.month} {data.time.day} {data.time.year}</div>
                                    </div>
                                </div>
                            );
                        } )
