...
const Footer = ( {data} ) => {
    return(
        <div className="footer">
            <div className="cntre4 cntre3 bg-c-pink img-rad4 ptop-btm news-letter">
            ...
            <div className="bg-c-pink-l">
                <div className="cntre ptop-btm3 flx-btwn flx-wrp mrgn-zero">
                    <div className="set-wth4  grid-gap3">
                        <div className="title4">{data.aboutUs.title}</div>
                            ...
                            data.recentAndMostPopular.map( (el, i) => {
                                return(
                                    <div className="set-wth5 grid-gap3" key={i}>
                                        <div className="title4">{el.headline}</div>
                                                    ...
                                                    return(
                                                        <div className="flx-btwn-gp" key={j}>
                                                            ...
                                                            <div className="cntre2">
                                                                <div className="txt-ft-16">{item.title}</div>
                                                                <div className="created-by created-by-b">{item.createdBy} <span className="edge edgeb"></span> {item.time.month} {item.time.day} {item.time.year}</div>
                                                            </div>
                                                        </div>
                                                    );
                                                } )
            ...
            <div className="cntre flx-btwn mrgn-zero res-flx-wrp-gp">
                <div className="txt-ft-16-400">{data.copyrightTxt} <a className="f-wt pink-col" href="#">{data.copyrightBy}</a></div>
